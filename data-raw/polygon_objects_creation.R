...
texts_thes <- tibble::tribble(
  ...
  # "glossary_var_desc", "Variable description", "Descripción de la variable", "Descripció de la variable",
  # "glossary_var_units", "Variable units", "Unidades de la variable", "Unitats de la variable",
  # "data_progress", "Retrieving data. When diameter classes are selected this can take a while", "Recopilando datos. Cuando se han seleccionado clases diamétricas puede tardar un poco", "Recopilant dades. Quan s'han seleccionat classes diamètriques pot trigar una mica",
  # "data_tab_1", "1. Breakdown level", "1. Desglose", "1. Desglossament",
  # "data_tab_2", "2. Filters", "2. Filtros", "2. Filtres",
  # "data_tab_3", "3. Visualization controls", "3. Visualización", "3. Visualització",
  # "data_tab_4", "4. Save the map", "4. Guardar el mapa", "4. Guardar el mapa",
  # "functional_group_input", "Select the breakdown level", "Seleccciona el nivel de desglose", "Selecciona el nivell de desglossament",
  # "h4_additional_controls", "Additional controls", "Controles adicionales", "Controls addicionals",
  # "municipalities", "Municipalities", "Municipios", "Municipis",
  # "n_y_axis_infoplot", "Number of plots", "Número de parcelas", "Nombre de parcel·les",
  # "natura_network_2000s", "Natura 2000 network", "Red Natura 2000", "Xarxa Natura 2000",
  # "natural_interest_areas", "Natural interest areas", "Áreas de interés natural", "Àrees d'interès natural",
  # "plot", "Plots", "Parcelas", "Parcel·les",
  # "plots", "Plots", "Parcelas", "Parcel·les",
  # "polygon", "Shapes", "Formas", "Formes",
  # "provinces", "Provinces", "Provincias", "Provincies",
  # "regions", "Regions", "Comarcas", "Comarques",
  # "save_shp_button", "Save as shapefile", "Guardar como shapefile", "Guardar com a shapefile",
  # "special_protection_natural_areas", "Special protection natural areas", "Áreas naturales de protección especial", "Àrees naturals de protecció especial",
  # "sweet_alert_hri_title", "Data info", "Info datos", "Info dades",
  # "sweet_alert_table_dc_text", "Saving the data broken down by diameter classes can take some time", "Guardar los datos desglosados por clases diamétricas puede llevar algún tiempo", "Guardar les dades desglossades per classes diamètriques pot comportar un cert temps",
  # "sweet_alert_table_dc_title", "Note:", "Nota:", "Nota:",
  # "table_build_progress", "Preparing table data...", "Preparando la tabla de datos...", "Preparant la taula de dades...",
  # "veguerias", "Veguerias", "Veguerias", "Vegueries",
  # "advanced_fg_options", "Show/Hide advanced options", "Muestra/Oculta opciones avanzadas", "Mostra/Amaga opcions avançades",
  # "data_format", "Format", "Formato", "Format",
  # "download", "Download", "Descargar", "Descarregar",
  # "hri", "Info about the query", "Información sobre la consulta", "Informació sobre la consulta",
  # "glossary", "Variables glossary", "Glosario de variables", "Glossari de variables",
)
